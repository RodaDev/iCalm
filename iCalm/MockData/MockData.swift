...
let thirdBreatheModel = BreatheModel(program: .init(title: "Антистресс", stages: thirdPrStages, laps: 8,image: "houseLake"), colorStart: .purple, colorEnd: .pink)

let forthPrStages = [BreatheStage(type: .breatheIn, interval: 7, source: .nose),
                      BreatheStage(type: .breatheOut, interval: 11, source: .nose)]
let forthBreatheModel = BreatheModel(program: .init(title: "Остановка паники", stages: forthPrStages, laps: 8, image: "house"), colorStart: .green, colorEnd: .cgCyan)
